...
public class PdfAddActivity extends AppCompatActivity {
    ...
    private void validateData() {
        ...
        if(TextUtils.isEmpty(title)){
            ...
            Toast.makeText(PdfAddActivity.this, "Pick Book Category ...", Toast.LENGTH_SHORT).show();
        }else if(pdfUri == null){
            Toast.makeText(PdfAddActivity.this, "Attack your Pdf ... ", Toast.LENGTH_SHORT).show();
        }else{
            uploadPdfToStorage();
        }
    }
